// GoodSound Official Website - i18n & Interactive Logic
...
const translations = {
  en: {
    ...
    heroDesc: "GoodSound crafts tailored acoustic environments using real-time algorithmic sound synthesis. Combine pure white, pink, and brown noise with gentle rain, warm fires, ocean waves, and cozy lofi backgrounds for uninterrupted sleep and laser focus.",
    heroDownloadBtn: "Download Solana APK",
    heroLearnMore: "Explore Features",
    heroExploreBtn: "Explore Features",
    badgeSolana: "Solana Seeker Ready",
    ...
    cap1Title: "Multi-track DSP Mixer",
    cap1Desc: "Custom blend with individual volume and rapid clear tools",
    cap2Title: "Zen Bedside Clock",
    cap2Desc: "Dynamic animated lofi backgrounds with double-tap exit",
    cap3Title: "Sleep Timer & Fadeout",
    cap3Desc: "Smooth 30s volume decrease for peaceful transition to sleep",
    cap4Title: "PRO Membership Plans",
    cap4Desc: "Flexible Monthly (NT$30), 72% Off Annual (NT$99), Lifetime (NT$300)",
    dlTitle: "Ready for Peaceful Sleep Tonight?",
    dlDesc: "Download GoodSound for Android & Solana Seeker devices. 100% offline, lightweight, and battery-friendly.",
    dlBtnSolanaSmall: "Solana Mobile / Android",
    dlBtnSolanaLarge: "Download Solana APK",
    dlBtnGitSmall: "Open Source Releases",
    dlBtnGitLarge: "GitHub Releases",
    ...
    privHighDesc: "GoodSound is built with a privacy-by-design architecture. All sound synthesis, timers, and volume preferences run 100% locally on your device. We do not track, collect, or transmit any personally identifiable information (PII).",
    p1Head: "1. Information Collection & Processing",
    p1Desc: "GoodSound does NOT require user registration, login credentials, contact lists, location tracking, or microphone access. Specifically:",
    ...
    p2Desc: "GoodSound requests only the minimum necessary permissions required for reliable background sleep playback:",
    ...
    p3Desc: "GoodSound utilizes Google AdMob to offer free access. To maintain a tranquil sleep environment, our advertising implementation adheres to strict anti-disturbance principles:",
    ...
    p4Desc: "The Solana Edition of GoodSound is distributed via the Solana dApp Store. Please note that GoodSound does NOT connect to cryptocurrency wallets, does not request private keys, and does not conduct blockchain transactions. It is a standalone audio application optimized for the Solana Seeker device ecosystem.",
    p5Head: "5. Children's Privacy (COPPA Compliance)",
    p5Desc: "GoodSound does not target children under the age of 13 and does not collect any personal data from children or adults alike.",
  ...
  zh: {
    ...
    heroDesc: "GoodSound 透過即時演算法合成專屬聲音環境。自由融合純淨白噪音、粉紅噪音、棕色噪音與雨聲、柴火、海浪及溫馨 Lofi 背景，打造極致沉浸的助眠與專注體驗。",
    heroDownloadBtn: "下載 Solana 版本 APK",
    heroLearnMore: "探索功能",
    heroExploreBtn: "探索功能",
    badgeSolana: "適配 Solana Seeker",
    ...
    cap1Title: "多音軌 DSP 混音介面",
    cap1Desc: "即時滑桿調整各音軌音量，附帶一鍵清除所有聲音",
    cap2Title: "沈浸式床頭時鐘",
    cap2Desc: "動態 Lofi 夜空背景與防誤觸點兩下退出設計",
    cap3Title: "智慧睡眠定時倒數",
    cap3Desc: "最後 30 秒自動漸弱淡出，守護安穩入眠",
    cap4Title: "PRO 專業版多樣方案",
    cap4Desc: "彈性每月 (NT$30)、超值年省 -72% (NT$99)、終身買斷 (NT$300)",
    dlTitle: "今晚就享受一場純淨深層好眠",
    dlDesc: "立即下載 GoodSound for Android & Solana Seeker。100% 本地運算、極致省電、零資料收集。",
    dlBtnSolanaSmall: "Solana Mobile / Android 直裝",
    dlBtnSolanaLarge: "下載 Solana 版本 APK",
    dlBtnGitSmall: "開放原始碼發布頁",
    dlBtnGitLarge: "GitHub Releases",
    privTag: "合規與透明承諾",
    privTitle: "隱私權政策 (Privacy Policy)",
    privSubtitle: "最後更新：2026 年 9 月 16 日 • 即刻生效",
    privHighTitle: "🔒 核心承諾：",
    privHighDesc: "GoodSound 秉持「隱私第一」設計原則。所有音訊合成、定時倒數與個人偏好設定均 100% 僅在您的手機本地運行。我們絕不追蹤、收集或傳輸任何個人身分資料 (PII)。",
    p1Head: "1. 資料收集與處理原則",
    p1Desc: "GoodSound 不需要使用者註冊、登入帳號、通訊錄權限、位置資訊或麥克風權限。具體說明如下：",
    p1L1Title: "零個人個資：",
    ...
    p2Desc: "GoodSound 僅申請維持背景助眠播放所需的最少必要權限：",
    ...
    p3Head: "3. 廣告與防干擾原則",
    p3Desc: "GoodSound 透過 Google AdMob 提供免費使用。為維護寧靜的助眠品質，廣告實施嚴格規範：",
    p3L1: "所有橫幅廣告均強制靜音，絕不發出突發聲音。",
    p3L2: "廣告位置遠離主要操作區域，避免睡眠前誤觸。",
    p3L3: "升級 PRO 專業版使用者享有無廣告純淨體驗。",
    p4Head: "4. Solana 版本生態說明",
    p4Desc: "GoodSound Solana 版本透過 Solana dApp Store 發行。本應用不連接加密貨幣錢包、不索取私鑰、不進行任何區塊鏈金流交易，為專為 Solana Seeker 裝置優化的獨立助眠應用。",
    p5Head: "5. 兒童隱私保護 (COPPA 合規)",
    p5Desc: "GoodSound 不針對 13 歲以下兒童收集任何資料，全年齡層皆可安心使用。",
    p6Head: "6. 聯絡與支援管道",
