...
const translations = {
  en: {
    ...
    heroDownloadBtn: "Download APK (v1.0.5)",
    ...
    dlDesc: "Download GoodSound for Android. 100% offline, lightweight, and battery-friendly.",
    dlBtnApkSmall: "Android APK Direct Download",
    dlBtnApkLarge: "Download APK (v1.0.5)",
  ...
  zh: {
    ...
    dlDesc: "立即下載 GoodSound for Android。100% 本地運算、極致省電、純淨助眠。",
    dlBtnApkSmall: "Android APK 直接下載",
    dlBtnApkLarge: "APK 下載 (v1.0.5)",
    privTag: "合規與透明承諾",
